...
public class HymnFinder {
    ...
    public String getFirstResult(String query) throws IOException {

        // Get all links on search page
        Document doc = Jsoup.connect("https://hymnary.org/search?qu=" + query.replace(" ","+")).get();
    ...
    public String getStanzas(String query) throws IOException {
        ...
        var element = doc.getElementsByClass("authority_columns").get(0);
